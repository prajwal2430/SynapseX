...
class EnvironmentVariables {
    constructor() {
        ...
        this.PORT = 3001;
        this.API_PREFIX = 'api';
        this.CORS_ORIGINS = 'http://localhost:3000,http://localhost:5173';
        this.LOG_LEVEL = 'debug';
        this.MONGODB_MAX_POOL_SIZE = '50';
        this.MONGODB_MIN_POOL_SIZE = '10';
        ...
        this.NEO4J_URI = 'bolt://localhost:7687';
        this.NEO4J_USER = 'neo4j';
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'MONGODB_URI is required' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], EnvironmentVariables.prototype, "AI_SERVICE_API_KEY", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], EnvironmentVariables.prototype, "NEO4J_URI", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], EnvironmentVariables.prototype, "NEO4J_USER", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], EnvironmentVariables.prototype, "NEO4J_PASSWORD", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], EnvironmentVariables.prototype, "NEO4J_DATABASE", void 0);
function validateEnvironment(config) {
    ...
    if (errors.length > 0) {
        const formattedErrors = errors
            ...
            return `[ENV_ERROR] ${error.property}: ${constraints}`;
        })
            .join('\n');
